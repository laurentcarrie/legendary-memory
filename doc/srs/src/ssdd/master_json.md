...
[rust doc for master file](/songbook-lambda/songbook/config/input_model/struct.UserSong.html)


## available section types

The list of valid sections is built at compile time, it is read with serde json from this file :
 [others/texfiles/sections.json](/songbook-lambda/others/texfiles/sections.json)
