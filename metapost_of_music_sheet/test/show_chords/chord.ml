...
let main () =
  let result =
    Jingoo.Jg_template.from_string Metapost_of_music_sheet_lib.Emitter.sheet_jingoo
      ~models:
        [
          ...
          ( "vardef_make_flat",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_flat );
          ( "vardef_make_sharp",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_sharp );
          ( "vardef_make_draw_chord",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_draw_chord
          );
          ( "vardef_make_glyph_of_chord",
            Jingoo.Jg_types.Tstr
              Metapost_of_music_sheet_lib.Mp_code.make_glyph_of_chord );
          ( "vardef_make_seven",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_seven );
          ( "vardef_make_major_seven",
            Jingoo.Jg_types.Tstr
              Metapost_of_music_sheet_lib.Mp_code.make_major_seven );
          ( "vardef_make_minor",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_minor );
          ( "vardef_make_draw_bati",
            Jingoo.Jg_types.Tstr Metapost_of_music_sheet_lib.Mp_code.make_draw_bati
          );
        ]
  in
  let result = Metapost_of_music_sheet_lib.Emitter.clean_string result in
  let fout = open_out "chord.mp" in
  let _ = fprintf fout "%s\n" result in
  let _ = close_out fout in
(*  let _ = Metapost_of_music_sheet_lib.Pdf.mps_of_mp sheet in *)
(*  let _ = Metapost_of_music_sheet_lib.Pdf.pdf_of_tex "chord" in *)
  ()
;;
