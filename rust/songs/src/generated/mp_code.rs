pub fn make_flat() -> String {
    let ret = r###"vardef make_flat(suffix ret)(expr chord)=
    save is_flat,t;
	boolean is_flat ;
...
pub fn make_sharp() -> String {
    let ret = r###"vardef make_sharp(suffix ret)(expr chord)=
    save is_sharp,t;
	boolean is_sharp ;
...
pub fn make_seven() -> String {
    let ret = r###"vardef make_seven(suffix ret)(expr chord)=
    boolean is_seven ;
...
pub fn make_minor() -> String {
    let ret = r###"vardef make_minor(suffix ret)(expr chord)=
    save is_minor,t;
	boolean is_minor ;
...
pub fn make_major_seven() -> String {
    let ret = r###"vardef make_major_seven(suffix ret)(expr chord)=
...
pub fn make_draw_bati() -> String {
    let ret = r###"vardef draw_bati(expr p) =
    %save p ;
    %path p ;
...
pub fn make_glyph_of_chord() -> String {
    let ret = r###"% freehand_segment and freehand_path
...
pub fn make_draw_row() -> String {
    let ret = r###"vardef draw_row(expr A,cell_width,cell_height,nbbars,nbchords,background)(suffix chords,barindex,nbchordsinbar,indexinbar) =
    save chord ;
    color c ;
    c := (0,0,0) ;
    B0 := A ;
...
pub fn make_draw_chord() -> String {
    let ret = r###"numeric ratio ;
ratio = .5 * .1 ;
