...
use crate::model::use_model::{Book, ELogType, LogItem, LogItemBook, LogItemSong, Song, World};
        ...
        let style = match s {
            LogItem::Song(s) => {
                ...
                match &s.status {
                    ...
                    ELogType::Wav(wav) => style_song(&s, format!("wav {wav}")),
            ...
            LogItem::Book(s) => {
                ...
                match &s.status {
                    ...
                    ELogType::Wav(_) => style_book(&s, "lilypond".to_string()),
