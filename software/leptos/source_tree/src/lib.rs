...
pub mod protocol;
use protocol::model::answer::{Progress,ProgressItem} ;

pub mod util;
use util::{
    build, default_world, fetch_world, get_something_to_see, save_file, SourceTreeItem_of_base64,
    WhatToShow,
};
...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <div class="split right">
                ...
                <Progress wts=what_to_show data=omake_progress/>
