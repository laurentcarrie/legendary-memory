...
pub mod util;
use util::{default_world, get_file,save_file, fetch_world, build,SourceTreeItem_of_base64 ,WhatToShow};
                            ...
                            {move || Suspend::new(async move {
                                ...
                                view!{
                                    ...
                                    on:change:target=move |ev| {
                                        ...
                                        set_what_to_show(WhatToShow::SourceFile(c.masterjsonfile) ;
