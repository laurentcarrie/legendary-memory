...
let main () =
  let result =
    Jingoo.Jg_template.from_string Song_book_builder.Emitter.sheet_jingoo
      ~models:
        [
          ...
          ( "vardef_make_flat",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_flat );
          ( "vardef_make_sharp",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_sharp );
          ( "vardef_make_draw_chord",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_draw_chord );
          ( "vardef_make_glyph_of_chord",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_glyph_of_chord
          );
          ( "vardef_make_seven",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_seven );
          ( "vardef_make_major_seven",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_major_seven );
          ( "vardef_make_minor",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_minor );
          ( "vardef_make_draw_bati",
            Jingoo.Jg_types.Tstr Song_book_builder.Mp_code.make_draw_bati );
        ]
  in
  let result = Song_book_builder.Emitter.clean_string result in
  let fout = open_out "chord.mp" in
  let _ = fprintf fout "%s\n" result in
  let _ = close_out fout in
  (*  let _ = Song_book_builder.Pdf.mps_of_mp sheet in *)
  (*  let _ = Song_book_builder.Pdf.pdf_of_tex "chord" in *)
  ()
;;
