...
let () =
  ...
  let buildroot = Array.get Sys.argv 1 in
  let srcdir = Array.get Sys.argv 2 in
  (*  let _ = Song_book_builder.Pdf.make_pdf yaml_filename in *)
  let _ = Song_book_builder.Makefile.make_makefile buildroot srcdir in
